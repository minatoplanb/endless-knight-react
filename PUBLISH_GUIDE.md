...
- [x] 上傳隱私政策到公開網址（已託管於 GitHub Pages）
- [x] 製作 Feature Graphic (1024x500px)（已有 `store-assets/feature-graphic-1024x500.png`）
- [x] 截取遊戲截圖（已有 `store-assets/screenshots/` 至少 2 張）
- [ ] 完整測試遊戲
- [ ] 建置 APK/AAB
...
隱私政策已託管於 **GitHub Pages**。請在 Google Play Console 填寫你的實際 URL。

<details>
<summary>若需重新託管，可參考以下方式</summary>
...
- [x] 隱私政策已上傳並可訪問（GitHub Pages）
- [x] Feature Graphic 已製作（1024x500px）
- [x] 截圖已準備（store-assets/screenshots/）
- [ ] 遊戲已完整測試（建議建置前跑一輪）
- [x] 版本號為 1.0.0
- [ ] Expo 帳號已註冊
